...
### Strategy
1. Read three double values from a single line
...
| `double.Parse()` | Converts string values to double |
| Formulas calculate five different areas | See formulas below |
| `ToString("F3")` | Formats output to 3 decimal places |

## 📐 Geometric Formulas

| Shape | Formula | Variable Meaning |
|-------|---------|------------------|
