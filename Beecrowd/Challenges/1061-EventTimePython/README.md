...
| Component | Purpose |
|-----------|---------|
| `input().split()` | Parses day input ("Dia xx") |
| `split(' : ')` | Parses time input with spaces around colons |
...
| `duration // 86400` | Calculates days (integer division) |
...
- **4 lines of input**:
  1. "Dia dd" (start day)
  2. "hh : mm : ss" (start time with spaces)
  3. "Dia dd" (end day)
  4. "hh : mm : ss" (end time with spaces)
