...
### Strategy
1. Read a float value
2. Check each interval in order using if-elif-else conditions
...
| Component | Purpose |
|-----------|---------|
| `float(input())` | Reads floating-point number |
| `n >= 0 and n <= 25` | Checks first interval [0,25] |
| `n > 25 and n <= 50` | Checks second interval (25,50] |
| `n > 50 and n <= 75` | Checks third interval (50,75] |
| `n > 75 and n <= 100` | Checks fourth interval (75,100] |
...
- **if-elif-else chain** ensures only one condition matches
